...
class ProductVO(db.Model):
    ...
    product_description = db.Column('product_description', db.String(1000), nullable=False)
    product_image_name = db.Column('product_image_name', db.String(255), nullable=False)
    product_image_path = db.Column('product_image_path', db.String(500), nullable=False)
